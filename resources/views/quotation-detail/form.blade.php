<div class="form-group {{ $errors->has('quotation_id') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="quotation_id" type="number" id="quotation_id" value="{{ isset($quotationdetail->quotation_id) ? $quotationdetail->quotation_id : ''}}" >
...
<div class="form-group {{ $errors->has('total') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="total" type="number" id="total" value="{{ isset($quotationdetail->total) ? $quotationdetail->total : ''}}" >
