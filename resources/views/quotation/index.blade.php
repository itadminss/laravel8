            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="GET" action="{{ url('/quotation') }}" accept-charset="UTF-8" class="form-inline my-2 my-lg-0 f col-3" role="search" style="float: right">
                            ...
                            <table class="table">
                                ...
                                @endphp
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $item->customer_id }}</td><td>{{ $item->user_id }}</td><td>{{ $item->vat_percent }}</td><td>{{ $item->vat }}</td><td>{{ $item->sub_total }}</td><td>{{ $item->net_total }}</td> --}}
