            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                            ...
                            <a href="{{ url('/post/create') }}" class="btn btn-success btn-sm  float-left" title="Add New Post">
                                <i class="fa fa-plus" aria-hidden="true"></i> Add New
                            </a>
    
                            <form method="GET" action="{{ url('/post') }}" accept-charset="UTF-8" class="col-2 form-inline my-2 my-lg-0 float-right" role="search">
